...
public abstract class Pekerja implements AturanKerja {
    private String id;
    String nama;
    ...
    // IMPLEMENTASI METHOD DARI INTERFACE AturanKerja
    @Override
    public void absenMasuk() {
        System.out.println("Pekerja " + nama + " telah melakukan absen masuk.");
    }

    @Override
    public void absenPulang() {
        System.out.println("Pekerja " + nama + " telah melakukan absen pulang.");
    }
